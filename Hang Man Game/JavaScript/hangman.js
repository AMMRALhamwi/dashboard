...
const words = {
  programming: ["php", "java", "javaScript", "mysql", "python", "cpp", "html"],
  ...
  countries3: ["Italy", "Mexico", "Egypt", "Argentina"],
  mountains: [
    "Everest",
    "Kilimanjaro",
    "Denali",
  ...
  superheroes: ["Superman", "Batman", "Spiderman", "Ironman"],
  ...
  vegetables: ["carrot", "broccoli", "tomato", "cucumber", "potato"],
  snacks: ["chips", "popcorn", "pretzels", "nuts", "cookies", "crackers"],
  condiments: ["ketchup", "mustard", "mayonnaise", "salsa", "ranch"],
  pastas: [
    "spaghetti",
    "macaroni",
    "fettuccine",
  ...
  desserts4: ["macarons", "tiramisu", "eclairs"],
  ...
  games: ["Tetris", "Minecraft", "Fortnite", "Overwatch"],
  constellations: [
    "Orion",
    "Ursa Major",
    "Cassiopeia",
  ...
  condiments2: ["sriracha", "tahini", "chutney", "ponzu"],
  accessories: [
    "earrings",
    "scarf",
    "sunglasses",
  ...
  superheroes2: ["Superman", "Spiderman", "Thor"],
  sports4: ["badminton", "rugby", "golf", "bowling"],
  ...
  movies2: ["Forrest Gump", "Fight Club"],
  dogBreeds: ["Bulldog", "Poodle", "Beagle"],
  catBreeds: [
    "Siamese",
    "Persian",
    "Maine Coon",
  ...
  seaCreatures: ["Dolphin", "Octopus", "Starfish", "Jellyfish", "Shark"],
  sports5: [
    "cricket",
    "volleyball",
    "badminton",
  ...
  beverages2: ["smoothie", "iced tea", "lemonade", "margarita", "milkshake"],
  vehicles: [
    "motorcycle",
    "helicopter",
    "yacht",
  ...
  bookGenres: ["thriller", "romance", "mystery", "fantasy", "horror"],
  insects2: [
    "butterfly",
    "dragonfly",
    "bee",
